...
Cilj Sprinta 2 je razraditi prioritetne stavke iz Product Backloga u jasnije i provjerljive zahtjeve. Fokus sprinta je na definisanju user stories, acceptance criteria i početnih nefunkcionalnih zahtjeva za ključne funkcionalnosti MVP verzije sistema.

Tokom ovog sprinta tim želi detaljnije definisati osnovni tok korištenja sistema, od registracije i prijave korisnika do upravljanja timovima i rezervacije termina. Na ovaj način stvaramo kvalitetnu osnovu za naredne faze modeliranja, arhitekture i kasnije implementacije.
