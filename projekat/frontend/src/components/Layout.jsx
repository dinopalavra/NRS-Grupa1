...
const navItems = [
  ...
  { key: "users",        label: "Korisnici",      Icon: IconUsers },
  { key: "teams",        label: "Timovi",         Icon: IconShield },
  { key: "timeslots",    label: "Termini",        Icon: IconClock },
  { key: "reservations", label: "Rezervacije",    Icon: IconCalendar },
];
